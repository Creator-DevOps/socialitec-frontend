...
const DeleteCoordinatorModal: React.FC = () => {
  const { isDeleteOpen, selected, closeDelete, handleDelete } = useCoordinators();
  ...
  return (
    <ModalContainer visible onClose={closeDelete}>
      <div className="flex flex-col gap-6 md:px-6 text-center">
        <h2 className="text-2xl font-bold text-primary">Eliminar Coordinador</h2>
...
export default DeleteCoordinatorModal;